...
In this model we add a third party to our society. The elections and the individual utility functions are identical to the ones used in the model above.
